...
#input_path = r'/home/paul/Desktop/Work_projects/Pass_translate/VideoCapture/img.png'
...
def contour_det(in_path, o_path): #, choise
    ...
    new_img = imutils.rotate_bound(new_img, - 90)  # Если изображение горизонтальное, то поворачиваем до вертикального состояния
   ...
   # if choise == 0: #Вырезать с исходного изображения паспорт целиком
    ...
    return first_page, second_page, num #img,
    # else:
    #     print("OOPSS")
...
#if choise == 1:
first_p, sec_p, num = contour_det(input_path, output_path)
